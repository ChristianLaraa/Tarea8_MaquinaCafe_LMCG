...
public class MaquinaCafe {
    ...
    public void Americano() {
        if (this.agua >= 180 && this.cafe >= 15 && this.vasos >= 1) {
            ...
            System.out.println("Faltan ingredientes para poder preparar un café Americano :( ");
        }
    }
    ...
    public void Expreso() {
        if (this.agua >= 120 && this.cafe >= 20 && this.vasos >= 1) {
            ...
            System.out.println("Faltan ingredientes para poder preparar un café Expresso");
        }
    }
    ...
    public void Capuchino() {
        if (this.agua >= 100 && this.cafe >= 14 && this.crema >= 70 && this.vasos >= 1) {
            ...
            this.vasos--;
            Capuchinos++;
            System.out.println("Capuchino reaady!! ");
        } else {
            System.out.println("Faltan ingredientes para poder preparar un café Capucchino");
        }
    }
